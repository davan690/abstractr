...
```{r fig.width=7, fig.height=4}
# c("#008B00")
# c("#008B00", "#00008B", "#CD8500")
# c("#008B00", "#FFFFFF", "#FFFFFF")

panel1 <- canvas + 
          theme_void() + 
          theme(panel.background = element_rect(fill = '#008B00', colour = '#008B00'))
...
panel2 <- canvas + 
          theme_void() + 
          theme(panel.background = element_rect(fill = "#00008B", colour = "#00008B"))

panel3 <- canvas + 
          theme_void() + 
          theme(panel.background = element_rect(fill = "#CD8500", colour = "#CD8500"))
```
...
panel1 <- canvas + 
          ...
          annotate("text", x=5.5, y=1.5, label = "Units 1",      size=8, fontface=2)
...
panel2 <- canvas + 
          ...
          geom_text(family='fontawesome-webfont', label=icon::fa("rocket")), 
                    x=5.5, y=5.5, size=5) +
...
panel3 <- canvas + 
          ...
          geom_text(family='fontawesome-webfont', label=fontawesome('fa-key'), 
                   x=5.5, y=5.5, size=25) +
...
p1 <- grid.arrange(panel1, panel2, panel3, ncol=3)
plot(p1)
```
![](support/final.png)
